...
const (
	// Player1Name is the default name for player 1 in test games.
	Player1Name = "Piet"
	// Player2Name is the default name for player 2 in test games.
	Player2Name = "Bob"
)

// SetupHandlerTest registers a cleanup hook to guarantee gameserver terminates and database state is cleaned up
