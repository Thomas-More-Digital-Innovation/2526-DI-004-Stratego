...
import (
	ai "digital-innovation/gostrategy/pkg/ai"
...
func NewAIWithAggression(player *game.Player, hasMemory bool, aggression float64) *AI {
...
func (ai *AI) findAttackMove(board *game.Board) (game.Move, bool) {
	memory := ai.GetMemory()
...
func (ai *AI) findExplorationMove(board *game.Board) (game.Move, bool) {
	enemyY := 0
